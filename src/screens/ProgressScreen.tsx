...
import { Image, View, Text, ActivityIndicator, Alert, TouchableOpacity } from 'react-native';
  ...
  <LinearGradient colors={['#f9bcdeff', '#bf86fcfe']} style={styles.container}>
    ...
    <PopoverHint visible={hintVisible} onClose={() => setHintVisible(false)}>
      <Text style={styles.hintText}>
        This is your personal data center —
        track every flashcard like it's a quantum particle.{"\n\n"}
