...
import { Pressable, Animated, View, Text, TextInput, TouchableOpacity, Image, Alert, ActivityIndicator } from 'react-native';
  ...
  <LinearGradient colors={['#f9bcdeff', '#bf86fcfe']} style={styles.container}>
    ...
    <View style={styles.bottomBar}>
      <Pressable
        ...
        style={({ pressed }) => [styles.navItem, pressed && styles.navIconActive]}
      >
